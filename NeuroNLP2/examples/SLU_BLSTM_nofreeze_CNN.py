...
from neuronlp2.models import BiRecurrentConv22, BiRecurrentConv, BiVarRecurrentConv
...
def main():
    ...
    if args.dropout == 'std':
        network = BiRecurrentConv22(embedd_dim, word_alphabet.size(),char_dim, char_alphabet.size(),
                                  num_filters, window,
