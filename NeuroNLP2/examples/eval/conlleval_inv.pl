...
while (<STDIN>) {
   ...
   if ($features[$#features] =~ /^([^-]*)-(.*)$/) {
      $guessed = $2;#$1
      $guessedType = $1;#$2
      #print (" guesed " , $guessed ," ",$guessedType,"\n");
   } else { 
...
if (not $latex) {
   ...
   #printf "correct chunk P : $correctChunk  correct found guessed: $foundGuessed.\n";
   #printf "correct chunk R : $correctChunk  correct found: $foundCorrect.\n";
